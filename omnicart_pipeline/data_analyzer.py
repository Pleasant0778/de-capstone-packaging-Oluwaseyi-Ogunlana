...
class DataAnalyzer:
  ...
  def analyze(self, df: pd.DataFrame) -> Dict[str, Dict[str, Any]]:
    ...
    return agg_df.to_json('seller_performance_report.json',  orient='index', indent=4)#agg_df.to_dict()#agg_df.to_json('seller_performance_report.json',  orient='index', indent=4)#agg_df.to_dict()
